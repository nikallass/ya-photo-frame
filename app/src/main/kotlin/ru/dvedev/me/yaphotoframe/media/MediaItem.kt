...
data class MediaItem(
     ...
     *
     * Снимку нужна копия с Диска. Ролику — нет: он играет из самого файла, а
     * постер и фон берутся из его первого кадра. Диск отдаёт превью роликов
     * лениво, и без этого правила тысячи роликов в свежеотмеченных папках
     * числились бы «нечем показать».
     */
    val isShowable: Boolean get() = kind == MediaKind.VIDEO || preview != null
}
