...
data class LibraryEntry(
    ...
    /**
     * Когда видео вытеснили из хранилища ради места. Пока не прошёл срок
     * «Не перекачивать», оно не качается снова: иначе флешка работала бы
     * буфером на один показ — скачали, показали, удалили, скачали.
     */
    val evictedAtMillis: Long? = null,
) {
