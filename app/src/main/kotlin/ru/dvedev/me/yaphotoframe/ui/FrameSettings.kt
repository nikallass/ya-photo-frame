...
data class FrameSettings(
     ...
     * через носитель, а без носителя он пропускается. Замерено на месте:
    ...
    /**
     * UUID тома флешки под тяжёлые ролики; пусто — носителя нет.
     *
    ...
    /**
     * Сколько места на носителе не занимать.
     *
